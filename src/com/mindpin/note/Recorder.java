...
public class Recorder implements OnCompletionListener, OnErrorListener {
    static final String SAMPLE_PREFIX = "my_recording";
...
//            try {
                ...
                mSampleFile = new File(sampleDir, SAMPLE_PREFIX + extension);
...
//                mSampleFile = File.createTempFile(SAMPLE_PREFIX, extension, sampleDir);
          /*  } catch (IOException e) {
           ...
           Log.v("mandy", "sampleDir: " + sampleDir.getAbsolutePath());
        }
        Log.v("mandy", "startRecording........................");
    ...
    public void startPlayback(String source) {
        ...
        Log.v("mandy", "start play back");
        stop();
        
        mPlayer = new MediaPlayer();
        try {
        	if (source == null) {
        		source = mSampleFile.getAbsolutePath();
        	}
